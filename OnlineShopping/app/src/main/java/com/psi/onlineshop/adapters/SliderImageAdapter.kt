...
class SliderImageAdapter(imageUrls: ArrayList<String>) :
    ...
    var sliderList: ArrayList<String> = imageUrls
    ...
    override fun onCreateViewHolder(parent: ViewGroup?): SliderImageAdapter.SliderViewHolder {
        // inside this method we are inflating our layout file for our slider view.
        val inflate: View =
            LayoutInflater.from(parent!!.context).inflate(R.layout.slider_image_item, null)
    ...
    override fun onBindViewHolder(viewHolder: SliderImageAdapter.SliderViewHolder?, position: Int) {
